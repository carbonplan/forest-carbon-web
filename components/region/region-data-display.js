  ...
  return (
    <>
      <Box>
        ...
        <Info>
          Activates a circular region inspector that you can drag and resize on
          the map. Committed emissions occurring within the circled region are
          summed to produce an annual time series.
        </Info>
      </Box>
